                          ...
                          child: ListTile(
                            ...
                            trailing: Row(
                              ...
                              children: [
                                ...
                                IconButton(icon: Icon(Icons.delete, color: Colors.red), onPressed: () => hapusDariKeranjang(p)),
                              ],
                            ),
                          ),
                        );
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  ...
                  Navigator.push(context, MaterialPageRoute(builder: (context) => HalamanPembayaran(total: totalBelanja, daftarBeli: keranjang)));
                },
